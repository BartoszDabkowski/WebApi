...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given commentId attribute.</summary>
    ///   <param name="commentId" type="String">An ID to search for, specified via the commentId attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
