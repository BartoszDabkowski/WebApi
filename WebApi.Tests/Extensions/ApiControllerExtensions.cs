...
namespace WebApi.Tests.Extensions
{
    public static class ApiControllerExtensions
    {
        public static void MockCurrentUser(this ApiController controller, string userId, string username)
        {
            ...
            identity.AddClaim(
                new Claim("http://schemas.xmlsoap.org/ws/2005/identity/claims/name", username));
            identity.AddClaim(
                new Claim("http://schemas.xmlsoap.org/ws/2005/identity/claims/nameidentifier", userId));
